...
vec2 windDir = vec2(0.2, -0.5); //wind direction XY
float windSpeed = 0.5; //wind speed

float scale = 350.0; //overall wave scale
...
float refrBump = 0.1; //refraction distortion amount

vec3 sunPos = vec3(0.0,700.0,300.0); //sun position
